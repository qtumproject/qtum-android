package com.pixelplex.qtum.ui.fragment.SmartContractsFragment.Light;
...
public class SmartContractsFragmentLight extends SmartContractsFragment{
    ...
    public void initializeViews() {
        ...
        settingsData.add(new SettingObject(R.string.create_contract,R.drawable.ic_my_new_contracts_light,0));
        settingsData.add(new SettingObject(R.string.my_contracts,R.drawable.ic_my_published_contracts_light,0));
