...
public class SmartContractsFragmentDark extends SmartContractsFragment {
    ...
    public void initializeViews() {
        ...
        settingsData.add(new SettingObject(R.string.my_contracts,R.drawable.ic_my_published_contracts,0));
        settingsData.add(new SettingObject(R.string.contracts_store,R.drawable.ic_contracts_store,0));
