...
class TouchIDPreferencePresenterImpl extends BaseFragmentPresenterImpl implements TouchIDPreferencePresenter {

    private TouchIDPreferenceView mTouchIDPreferenceView;
    private TouchIDInterractor mTouchIDPreferenceInteractor;

    TouchIDPreferencePresenterImpl(TouchIDPreferenceView view, TouchIDInterractor interractor) {
